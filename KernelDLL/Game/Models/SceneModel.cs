...
namespace KernelDLL.Game.Models
{
    ...
    {
        public SceneModel(int id, string descriptor, string header, int areaId, int width, int height, IList<TransitionModel> transitions,
        ...
        public IList<TransitionModel> Transitions { get; private set; }
